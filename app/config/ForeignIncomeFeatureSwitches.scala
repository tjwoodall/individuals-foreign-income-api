...
object ForeignIncomeFeatureSwitches {
  def apply()(implicit appConfig: AppConfig): ForeignIncomeFeatureSwitches = ForeignIncomeFeatureSwitches(appConfig.featureSwitchConfig)
}
