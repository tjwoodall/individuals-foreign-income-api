...
import common.models.errors.RuleRequestCannotBeFulfilled
...
import common.models.errors.InternalError
...
trait RequestHandlerOld[InputRaw <: RawData] {
  ...
  def handleRequest(
      rawData: InputRaw)(implicit ctx: RequestContext, request: UserRequest[_], app: AppConfig, ec: ExecutionContext): Future[Result]
