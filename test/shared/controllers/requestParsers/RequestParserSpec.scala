...
import shared.models.errors.{BadRequestError, ErrorWrapper, NinoFormatError, RuleIncorrectOrEmptyBodyError}
    ...
    "return multiple errors" when {
      "the validator returns multiple errors" in new Test {
        ...
        parser.parseRequest(Raw(nino)) shouldBe Left(
          ErrorWrapper(correlationId, BadRequestError, Some(List(NinoFormatError, RuleIncorrectOrEmptyBodyError))))
      }
    }
  }
