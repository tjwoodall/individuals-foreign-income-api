...
import v2.models.request.createAmend.{CreateAmendForeignRequestBody, ForeignEarnings, UnremittableForeignIncomeItem}
  ...
  "AmendForeignRequestBody" when {
    ...
    "read from valid JSON with an empty 'unremittableForeignIncome' array" should {
      "produce the expected AmendForeignRequestBody object" in {
        ...
        json.as[CreateAmendForeignRequestBody] shouldBe requestBodyModel.copy(unremittableForeignIncome = Some(Seq.empty))
      }
    }
